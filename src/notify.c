...
void notify_init(void) {
	class_replaceMethod(objc_getClass("NSBundle"), sel_registerName("bundleIdentifier"), method_getImplementation((void *)^{
...
void notify(const char *subtitle, const char *format, ...) {
	...
	void *notification =
		((void *(*)(void *, SEL, SEL))objc_msgSend)((void *)objc_getClass("NSUserNotification"), sel_registerName("alloc"), sel_registerName("init"));
