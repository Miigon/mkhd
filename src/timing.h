...
static inline uint64_t macos_get_wall_clock(void) { return mach_absolute_time(); }
...
static inline double macos_get_milliseconds_elapsed(uint64_t start, uint64_t end) {
	uint64_t ns = macos_get_nanoseconds_elapsed(start, end);
	return (double)(ns / 1000000.0);
}

static inline double macos_get_seconds_elapsed(uint64_t start, uint64_t end) {
	uint64_t ns = macos_get_nanoseconds_elapsed(start, end);
